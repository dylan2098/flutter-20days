import 'package:d8_splash_screen_and_login_ui/LoginPage.dart';
          ...
          children: <Widget>[
            Positioned(
              ...
              child: Container(
                width: width,
                height: 400,
                decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/images/one.png'), fit: BoxFit.cover)),
              ),
            ),
            Positioned(
              top: -100,
                        ...
                        child: Center(
                          child: AnimatedBuilder(
                            ...
                            builder: (context, child) => Container(
                              ...
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(50), color: Colors.blue.withOpacity(.4)),
                              child: InkWell(
                                onTap: () {
